...
import 'package:onestep_rezero/myinfo/utils/myProductFirebaseApi.dart';
import 'package:onestep_rezero/product/models/product.dart';

class MyCompletedProductProvider extends ChangeNotifier {
  ...
  Future fetchProducts() async {
    ...
    try {
      final snap = await MyProductFirebaseApi.getMyCompletedProducts(
        documentLimit,
        startAfter: null,
      );
