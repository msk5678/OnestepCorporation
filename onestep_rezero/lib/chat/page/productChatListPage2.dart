...
class ProductChatListPage2 extends StatefulWidget {
  @override
  _ProductChatListPageState createState() => _ProductChatListPageState();
}

class _ProductChatListPageState extends State<ProductChatListPage2>
    with AutomaticKeepAliveClientMixin<ProductChatListPage2> {
  ...
  void initState() {
    ...
    testFuture = FirebaseFirestore.instance
        .collection('user')
...
//                     mesageValues.toString());
  ...
  FutureBuilder getUserImage(int index, String proUserId, String chatId) {
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            AutoSizeText(
                              ...
                              style: TextStyle(
                                  fontSize: 14, color: Colors.black), //15
                              minFontSize: 10,
                              stepGranularity: 10,
                              maxLines: 1,
                            ...
                            Spacer(),
                            getChatListTime(listProductChat[index].recentTime),
                            // Container(
                            //   width: 130,
                            //   height: 530,
                            //   color: Colors.blue,
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: Container(
                                ...
                                height: 30,
                                child: Text(
                                  listProductChat[index].recentText,
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 2,
                                  style: TextStyle(
                                    fontSize: 12,
